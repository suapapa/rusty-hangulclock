...
make -f Makefile_homin ${TARGET} RUSTY_HANGULCLOCK_HW_REVISION=${HW_REVISION} RUSTY_HANGULCLOCK_SW_VERSION=${SW_VERSION} RUSTY_HANGULCLOCK_NO=${NO} RUSTY_HANGULCLOCK_OWNER=${OWNER}
