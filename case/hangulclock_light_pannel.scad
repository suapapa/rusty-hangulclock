difference() {
    union() {
        ...
        translate([-30,-35,0]) oled_supports_v_2();
        translate([20,-35,0]) board_supports_2();
        // translate([30,-35,0]) board_supports_2();
        cube([170, 170, 1.2], center=true);
        translate([-170/6,0,1]) cube([5,170, support_h], center=true);
        translate([+170/6,0,1]) cube([5,170, support_h], center=true);
        translate([0,17,1]) cube([170, 5, support_h], center=true);
        translate([0,17+34,1]) cube([170, 5, support_h], center=true);
        translate([0,-17,1]) cube([170, 5, support_h], center=true);
        translate([0,-17-34,1]) cube([170, 5, support_h], center=true);
    }
...
module board_supports_2() {
    translate([-(41.5-2)/2,-(46.5-2)/2]) {
        support(3, 4);
        translate([38,0,0]) support(3, 4);
        translate([0,47,0]) support(3, 4);
        translate([38,47,0]) support(3, 4);
    }
}

// for pcb rev1
module board_supports_1() {
