difference() {
    translate([0,0,40/2])
        difference() {
            cube([176,176,40-5], center=true);
            cube([165,165,70], center=true);
            translate([0,0,3+2.5]) cube([171,171,40], center=true);
            //translate([2.5,2.5,2.5]) cube([170,170,70]);
            translate([0,50,0+25+5]) cube([120,180,35], center=true);
        }

    translate([-170/2,170/2-5,24+2.5])
